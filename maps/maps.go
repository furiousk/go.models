...
func ReadType() (typer map[int]models.Typer) {

	typer[1] = models.Typer{Status: 1, Key: "ignicao"}
	typer[14] = models.Typer{Status: 0, Key: "null"}
	typer[38] = models.Typer{Status: 2, Key: "ignicao"}
	typer[42] = models.Typer{Status: 1, Key: "excessoVelSensor"}
	typer[43] = models.Typer{Status: 1, Key: "excessoRpmSensor"}
	typer[45] = models.Typer{Status: 1, Key: "excessoVelCan"}
	typer[46] = models.Typer{Status: 1, Key: "excessoRotacaoCan"}
	typer[51] = models.Typer{Status: 1, Key: "aceleracaoBrusca"}
	typer[52] = models.Typer{Status: 1, Key: "marchaLenta"}
	typer[170] = models.Typer{Status: 1, Key: "excessoVelSensor"}
	typer[171] = models.Typer{Status: 1, Key: "excessoRpmSensor"}
	typer[173] = models.Typer{Status: 1, Key: "excessoVelCan"}
	typer[174] = models.Typer{Status: 1, Key: "excessoRotacaoCan"}
	typer[179] = models.Typer{Status: 1, Key: "freadaBrusca"}
	typer[180] = models.Typer{Status: 1, Key: "marchaLenta"}
